...
=== Install
  ...
  sudo gem install cloud-manager-0.5.0.gem --local --no-ri --no-rdoc
...
config:
  ...
  placement_plugin:  ['plugin/placement_Your_Write', 'MyPlacement'] #You could select your own placement plugin
